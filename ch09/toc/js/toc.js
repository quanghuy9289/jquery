$(document).ready(function () {
  ...
  // wrap an <a> tag around h1 text
  $("h1").wrapInner("<a id='top'></a>");

  // insert back to top <a> tags after each topic
  $("article h2").before("<a href='#top'>Back to top</a>"); // insert before h2
  $("article a:first").remove(); // remove the first a because of redundant first link
  $("article p:last").after("<a href='#top'>Back to top</a>"); // insert after last p in article
});
